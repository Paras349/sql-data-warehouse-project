--Here we only have DDL script for Silver Layer Table defining structure without Stored procedure to create these tables again and agian we have to  manually execute it again to define table structure
